...
public class MainActivity extends AppCompatActivity {
    ...
    public void textToast(View v) {
        Toast.makeText(this,"Back button is selected.", Toast.LENGTH_LONG).show();
    }

    public void textSnackbar(View v) {
        Snackbar.make(v,"Next button is selected.",Snackbar.LENGTH_LONG).show();
    }
}
